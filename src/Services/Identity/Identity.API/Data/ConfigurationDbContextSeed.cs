...
using WhiskyArchive.Services.Identity.API.Configuration;
...
namespace WhiskyArchive.Services.Identity.API.Data
{
    public class ConfigurationDbContextSeed
    {
        public async Task SeedAsync(ConfigurationDbContext context, IConfiguration configuration)
        {
            ...
            clientUrls.Add("WhiskyRecordingApi", configuration.GetValue<string>("WhiskyRecordingApiClient"));
            ...
            clientUrls.Add("WebWhiskyArchiveAgg", configuration.GetValue<string>("WebWhiskyArchiveAggClient"));
