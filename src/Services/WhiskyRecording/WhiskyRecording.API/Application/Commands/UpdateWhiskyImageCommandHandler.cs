...
{
    public class UpdateWhiskyImageCommandHandler
     : IRequestHandler<UpdateWhiskyImageCommand, bool>
    {
        ...
        public UpdateWhiskyImageCommandHandler(IMediator mediator, IWhiskyRepository whiskyRepository, IEventBus eventBus)
        {
        ...
        public async Task<bool> Handle(UpdateWhiskyImageCommand message, CancellationToken cancellationToken)
        {
            ...
            existingWhisky.UpdateImages(message.Urls);
    ...
    public class UpdateWhiskyImageIdentifiedCommandHandler : IdentifiedCommandHandler<UpdateWhiskyImageCommand, bool>
    {
        public UpdateWhiskyImageIdentifiedCommandHandler(IMediator mediator, IRequestManager requestManager) : base(mediator, requestManager)
        {
        }
